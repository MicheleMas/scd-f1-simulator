...
Le tipologie di invio analizzate sono principalmente due, pull e push. Nel primo caso le informazioni devono essere recuperate esplicitamente, richiedendole all’intermediario, nel secondo vengono spedite a tutte le entità che ne hanno fatto richiesta durante il setup (secondo il modello publish subscribe). %TODO ho aggiunto le ultime due parole, mi sembrava giusto dirlo
...
Entrambe sono utili in determinate circostanze e quindi è stato deciso di adottarle entrambe.\\
